...
<div id='team' className={`mt-[15rem] ${ theme === 'dark' ? 'boxShadowDark' : 'boxShadow'} relative my-[15rem] h-[20rem] opacity-[0.7] hover:h-[30rem] hover:opacity-[1] transition-all duration-500`}>
