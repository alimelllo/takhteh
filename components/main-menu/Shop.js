...
const Shop = ( props ) => {
  ...
  <Fade left><p className={`text-center pl-[2rem] md:pl-0 text-[2.5rem] font-[Vibur] font-[600] ${ props.theme === 'light' ? 'text-[#363636]' : 'text-[#c3c3c3]'}  my-[1rem]`}>TAKHTEH SHOP</p></Fade>
<Fade right>
<div className='flex flex-row md:mx-auto md:mt-5'>
   
  <div className={` ${ props.theme === 'light' ? 'bg-[#e9e9e9] shadow-2xl' : 'bg-[#a1a1a1] boxShadowDark'} my-[2rem] w-[4rem] mx-5  rounded-[10px] `}>
  <Image src={union} layout="responsive" objectFit='cover' />
</div>
<div className={` ${ props.theme === 'light' ? 'bg-[#e9e9e9] shadow-2xl' : 'bg-[#a1a1a1] boxShadowDark'} my-[2rem] w-[4rem] mx-5 p-1  rounded-[10px] `}>
...
<div className='w-4/12 md:w-full my-[2rem]'>
  <div className={`w-full rounded-l-[20px] md:rounded-none  ${ props.theme === 'light' ? 'boxShadow' : 'boxShadowDark'} opacity-[0.8] cursor-pointer hover:opacity-[1] transition-all duration-300`}>
